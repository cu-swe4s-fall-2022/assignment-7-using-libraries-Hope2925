...
class TestUtils(unittest.TestCase):
    ...
    def test_get_file_dimensions(self):
        ...
        self.assertEqual(dp.get_file_dimensions(self.iris_file_name),
                         (150, 5))
    ...
    def test_write_matrix_to_file(self):
        ...
        dp.write_matrix_to_file(self.num_rows,
                                self.num_cols,
                                written_file_name)
        ...
        self.assertEqual(dp.get_file_dimensions(written_file_name),
                         (self.num_rows, self.num_cols))
